...
var mgValue = [6]int16{82, 337, 365, 477, 1025, 0}
var egValue = [6]int16{94, 281, 297, 512, 936, 0}
var gamephaseInc = [6]int16{0, 1, 1, 2, 4, 0}
...
var mgReferenceTable = [6]*[64]int16{&mgPawnTable, &mgKnightTable, &mgBishopTable, &mgRookTable, &mgQueenTable, &mgKingTable}
var egReferenceTable = [6]*[64]int16{&egPawnTable, &egKnightTable, &egBishopTable, &egRookTable, &egQueenTable, &egKingTable}

var mgTable = [12][64]int16{}
var egTable = [12][64]int16{}
...
func (board *Board) Evaluate() (retval int16) {
	/******************
	1. Piece evaluation
	*******************/
...
func PeSTOTableEval(board *Board) (retval, mgPhase, egPhase int16) {
	var mg, eg [2]int16
	var gamePhase int16
